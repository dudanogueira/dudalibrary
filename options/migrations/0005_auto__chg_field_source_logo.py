...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.logo'
        db.alter_column(u'options_source', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Source.logo'
        db.alter_column(u'options_source', 'logo', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))
