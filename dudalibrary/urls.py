...
urlpatterns += i18n_patterns('',
    ...
    url(_(r'^source/(?P<object_id>\d+)/'), 'frontend.views.source_details', name="source_details"),
    url(_(r'^source/points.txt$'), 'frontend.views.source_points', name="source_points"),
