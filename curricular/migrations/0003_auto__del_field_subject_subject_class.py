...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subject.subject_class'
        db.delete_column('curricular_subject', 'subject_class_id')


    def backwards(self, orm):
        # Adding field 'Subject.subject_class'
        db.add_column('curricular_subject', 'subject_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['curricular.SubjectClass']),
                      keep_default=False)
