...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CurricularGrade.parent'
        db.add_column('curricular_curriculargrade', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['curricular.CurricularGrade'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CurricularGrade.parent'
        db.delete_column('curricular_curriculargrade', 'parent_id')
    ...
    models = {
        ...
        'curricular.curriculargrade': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['curricular.CurricularGrade']", 'null': 'True', 'blank': 'True'}),
