...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CurricularGrade.title'
        db.alter_column('curricular_curriculargrade', 'title', self.gf('django.db.models.fields.CharField')(default='nonee', max_length=100))

    def backwards(self, orm):

        # Changing field 'CurricularGrade.title'
        db.alter_column('curricular_curriculargrade', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
